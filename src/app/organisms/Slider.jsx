...
const SlideContent = ({ title, buttonText, imageUrl }) => (
  <>
    ...
    <div className='text-white absolute w-[1100px] max-w-[95%] m-auto h-max top-[35%] grid gap-4 flex-wrap ml-6 text-right'>
        ...
        <Carousel.Caption className='h-dvh !left-0 !right-0 relative'>
          <div className='m-auto flex justify-center'>
            <SlideContent
              ...
              imageUrl='https://cdn.nody.ir/files/2021/10/13/nody-%D8%B9%DA%A9%D8%B3-%DA%AF%DB%8C%D8%AA%D8%A7%D8%B1-%D8%A8%D8%B1%D9%82%DB%8C-%D8%A8%D8%A7-%DA%A9%DB%8C%D9%81%DB%8C%D8%AA-1634153369.jpg'
            />
          </div>
        </Carousel.Caption>
      </Carousel.Item>
